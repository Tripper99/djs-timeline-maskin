...
# PyInstaller spec file for DJs Timeline Machine v2.6.18
# Updated for CustomTkinter compatibility (requires --onedir mode)
# v2.6.18: Fixed settings persistence for Linux AppImage and Windows .exe
...
exe = EXE(
    ...
    name='DJs_Timeline_Machine_v2.6.18',
    debug=False,

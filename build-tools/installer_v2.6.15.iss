; Inno Setup Script for DJs Timeline Machine v2.6.15
; This script creates a professional Windows installer

#define MyAppName "DJs Timeline Machine"
#define MyAppVersion "2.6.15"
#define MyAppPublisher "DJs Development"
#define MyAppExeName "DJs_Timeline_Machine_v2.6.15.exe"
...
Source: "..\dist\DJs_Timeline_Machine_v2.6.15\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
; Documentation files 
